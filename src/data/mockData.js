 ...
 *          autoSoldoutOnZeroStock, estimatedWaitMinutes, eventId, boothNumber,
...
(function () {
  ...
  var EVENT1_EXTRA_STORES = EVENT1_BOOTH_NAMES.map(function (name, idx) {
    ...
    return {
      ...
      autoSoldoutOnZeroStock: true,
      estimatedWaitMinutes: 5 + (idx % 4) * 5,
      eventId: 'event-1',
  ...
  var ORDERS = [
    ...
    { id: 'order-2', storeId: 'store-1', orderNo: 1002, pgOrderNo: pgOrderNo(1002), channel: 'TABLET', receiveType: 'COUNTER_PICKUP', tableOrPickupNo: '12', customerPhone: '02198761234', customerName: '박준호', status: 'COMPLETED', paymentStatus: 'PAID', totalAmount: 5000, orderedAt: minutesAgo(180), acceptedAt: minutesAgo(178), completedAt: minutesAgo(165), canceledAt: null, cancelReason: null, completedCount: 1, callStatus: 'FAILED', calledAt: null },
    { id: 'order-3', storeId: 'store-1', orderNo: 1003, pgOrderNo: pgOrderNo(1003), channel: 'QR', receiveType: 'TABLE_SERVICE', tableOrPickupNo: '2', customerPhone: '01033334444', customerName: '최수아', status: 'CANCELED', paymentStatus: 'PAID', totalAmount: 4500, orderedAt: minutesAgo(150), acceptedAt: null, completedAt: null, canceledAt: minutesAgo(147), cancelReason: '품절', completedCount: 0, callStatus: 'NOT_CALLED', calledAt: null },
    { id: 'order-4', storeId: 'store-1', orderNo: 1004, pgOrderNo: pgOrderNo(1004), channel: 'QR', receiveType: 'TABLE_SERVICE', tableOrPickupNo: '8', customerPhone: '01044445555', customerName: '정민재', status: 'RECEIVED', paymentStatus: 'PAID', totalAmount: 11800, orderedAt: minutesAgo(40), acceptedAt: minutesAgo(35), completedAt: null, canceledAt: null, cancelReason: null, completedCount: 0, callStatus: 'NOT_CALLED', calledAt: null },
    { id: 'order-5', storeId: 'store-1', orderNo: 1005, pgOrderNo: pgOrderNo(1005), channel: 'TABLET', receiveType: 'COUNTER_PICKUP', tableOrPickupNo: '15', customerPhone: '0105556666', customerName: '한소희', status: 'WAITING', paymentStatus: 'PAID', totalAmount: 5500, orderedAt: minutesAgo(15), acceptedAt: null, completedAt: null, canceledAt: null, cancelReason: null, completedCount: 0, callStatus: 'NOT_CALLED', calledAt: null },
    ...
    { id: 'order-att-1', storeId: 'store-3', orderNo: 9001, pgOrderNo: pgOrderNo(9001), channel: 'QR', receiveType: 'COUNTER_PICKUP', tableOrPickupNo: '1', customerPhone: '01099998888', customerName: null, status: 'WAITING', paymentStatus: 'PAID', totalAmount: 8000, orderedAt: minutesAgo(25), acceptedAt: null, completedAt: null, canceledAt: null, cancelReason: null, completedCount: 0, callStatus: 'NOT_CALLED', calledAt: null },
  ];
